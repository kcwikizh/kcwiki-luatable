    ...
    def __append_ship(self, ship_id):
        ...
        self.ships_data[wiki_ship['wiki_id']] = {
            ...
            '数据': {
                ...
                '对潜': [wctf_ship['stat']['asw'], int(round(wctf_ship['stat']['asw_max'] / 99 * 165))],
                '回避': [wctf_ship['stat']['evasion'], int(round(wctf_ship['stat']['evasion_max'] / 99 * 165))],
                '索敌': [wctf_ship['stat']['los'], int(round(wctf_ship['stat']['los_max'] / 99 * 165))],
